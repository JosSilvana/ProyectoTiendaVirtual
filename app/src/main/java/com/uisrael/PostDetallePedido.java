...
public class PostDetallePedido extends AsyncTask<Void, Void, String> {
    ...
    private String idPedidoFK="";
    private String idProductoFK="";
    private String cantidad="";
    private String subtotal="";

    public PostDetallePedido(Context ctx, String linkAPI, String idPedidoFK, String  idProductoFK, String cantidad, String subtotal){
    ...
    protected String doInBackground(Void... params) {
        ...
        try {
            ...
            parametrosPost.put("idPedidoFK", idPedidoFK);
            parametrosPost.put("idProductoFK",idProductoFK);
            parametrosPost.put("cantidad", cantidad);
            parametrosPost.put("subtotal", subtotal);
    ...
    protected void onPostExecute(String s) {
        ...
        resultadoapi=s;
        Toast.makeText(httpContext,"Productos comprados",Toast.LENGTH_LONG).show();//mostrara una notificacion con el resultado del request
    }
    //FUNCIONES----------------------------------------------------------------------
