...
public class postUsuario extends AsyncTask<Void, Void, String> {
    ...
    public postUsuario(Context ctx, String linkAPI,  String  nombre, String apellido, String email, String contrasenia){
    ...
    protected String doInBackground(Void... params) {
        ...
        try {
            ...
            parametrosPost.put("contrasenia",contrasenia);
    ...
    protected void onPostExecute(String s) {
        ...
        resultadoapi=s;
        Toast.makeText(httpContext,"Registro Exitoso",Toast.LENGTH_LONG).show();//mostrara una notificacion con el resultado del request
    }
    //FUNCIONES----------------------------------------------------------------------
