...
public class PutUsuario extends AsyncTask<Void, Void, String> {
    ...
    public PutUsuario(Context ctx, String linkAPI){
    ...
    protected void onPostExecute(String s) {
        ...
        resultadoapi=s;
        Toast.makeText(httpContext,"Actualizado",Toast.LENGTH_LONG).show();//mostrara una notificacion con el resultado del request
    }
}
