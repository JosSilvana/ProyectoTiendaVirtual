...
public class PostPedido extends AsyncTask<Void, Void, String> {
    ...
    public PostPedido(Context ctx, String linkAPI, String idUsuarioFK, String  fechaEnvio){
    ...
    protected String doInBackground(Void... params) {
        ...
        try {
            ...
            parametrosPost.put("idUsuarioFK", idUsuarioFK);
            parametrosPost.put("fechaEnvio",fechaEnvio);
    ...
    protected void onPostExecute(String s) {
        ...
        resultadoapi=s;
        Toast.makeText(httpContext,"Compra exitosa",Toast.LENGTH_LONG).show();//mostrara una notificacion con el resultado del request
    }
    //FUNCIONES----------------------------------------------------------------------
