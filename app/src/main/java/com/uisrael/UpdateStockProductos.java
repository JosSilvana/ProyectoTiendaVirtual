...
public class UpdateStockProductos extends AsyncTask<Void, Void, String> {
        ...
        public UpdateStockProductos(Context ctx, String linkAPI){
        ...
        protected void onPostExecute(String s) {
            ...
            Toast.makeText(httpContext,"Stock Actualizado",Toast.LENGTH_SHORT).show();//mostrara una notificacion con el resultado del request
        }
}
